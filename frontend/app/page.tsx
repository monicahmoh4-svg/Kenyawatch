...
import { Shield, FileText, MapPin, MessageSquare, ArrowRight, AlertTriangle, TrendingUp, Users, Building2 } from "lucide-react"
...
export default function HomePage() {
  ...
  const features = [
    { 
      ...
      description: "Search and filter contracts across all 47 counties with AI-powered risk scoring", 
      href: "/contracts", 
      color: "bg-blue-500",
      stat: stats?.total || 0,
      statLabel: "Contracts"
    ...
    { 
      ...
      description: "Identify infrastructure projects that were funded but never built", 
      href: "/ghost-projects", 
      color: "bg-red-500",
      stat: "47",
      statLabel: "Counties"
    ...
    { 
      ...
      description: "Safely report suspected corruption with end-to-end anonymity", 
      href: "/report", 
      color: "bg-green-500",
    ...
    { 
      ...
      description: "Ask natural language questions about procurement data", 
      href: "/chat", 
      color: "bg-purple-500",
      stat: "24/7",
      statLabel: "Available"
    ...
    <div>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div 
          ...
          style={{
            backgroundImage: "url('https://images.unsplash.com/photo-1523805009345-783ee736e547?w=1920&q=80')",
          }}
        >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-16 max-w-4xl mx-auto">
              <Card className="bg-white/10 backdrop-blur-md border-white/20 text-white shadow-xl">
                <CardContent className="p-6 text-center">
                  ...
                  <div className="text-sm text-slate-300">Total Contracts</div>
                </CardContent>
              </Card>
              <Card className="bg-white/10 backdrop-blur-md border-white/20 text-white shadow-xl">
                <CardContent className="p-6 text-center">
                  <div className="text-4xl font-bold text-green-400 mb-1">
                    {loading ? "—" : stats?.documented || 0}
                  </div>
                  <div className="text-sm text-slate-300">Documented Cases</div>
                </CardContent>
              </Card>
              <Card className="bg-white/10 backdrop-blur-md border-white/20 text-white shadow-xl">
                <CardContent className="p-6 text-center">
              ...
              <Card className="bg-white/10 backdrop-blur-md border-white/20 text-white shadow-xl">
                <CardContent className="p-6 text-center">
                  <div className="text-4xl font-bold text-blue-400 mb-1">
                    {loading ? "—" : stats?.reports_total || 0}
                  </div>
                  <div className="text-sm text-slate-300">Citizen Reports</div>
                </CardContent>
              </Card>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {features.map((feature, i) => (
              <Link key={i} href={feature.href}>
                <Card className="group hover:shadow-2xl transition-all duration-500 border-2 hover:border-kenya-teal/30 overflow-hidden h-full">
                  <CardContent className="p-10">
                    ...
                    <h3 className="text-2xl font-bold text-slate-900 mb-3 group-hover:text-kenya-teal transition-colors">
                      {feature.title}
                    </h3>
                    ...
                    <div className="flex items-center justify-between pt-4 border-t">
                      <div>
                        <div className="text-3xl font-bold text-kenya-teal">{feature.stat}</div>
                        <div className="text-sm text-slate-500">{feature.statLabel}</div>
                      </div>
                      <ArrowRight className="h-5 w-5 text-slate-400 group-hover:text-kenya-teal group-hover:translate-x-2 transition-all" />
                    </div>
                  </CardContent>
                </Card>
              </Link>
      ...
      <section className="py-20 bg-gradient-to-r from-teal-900 via-teal-800 to-slate-900 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-sm text-slate-400 pt-4 max-w-2xl mx-auto">
              Our mission is to grow the <Badge variant="documented" className="text-xs">Documented</Badge> dataset 
              by digitizing Auditor-General reports and partnering with oversight bodies.
            </p>
          </div>
        </div>
      </section>
